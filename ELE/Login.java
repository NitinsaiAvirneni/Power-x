...
public class Login extends JFrame implements ActionListener{
    ...
    Login() {
        super("Login Page");
        getContentPane().setBackground(new Color(0X45e1e6));
        setLayout(null);
        
        JLabel lblusername = new JLabel("Username");
        lblusername.setBounds(350, 120, 100, 20);
        lblusername.setFont(new Font("architectural", Font.BOLD, 14));
        add(lblusername);
        ...
        lblpassword.setFont(new Font("architectural", Font.BOLD, 14));
        ...
        loggininas.setFont(new Font("architectural", Font.BOLD, 14));
        ...
        ImageIcon i7 = new ImageIcon("secondd.png");
